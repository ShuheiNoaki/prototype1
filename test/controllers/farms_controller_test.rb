...
class FarmsControllerTest < ActionController::TestCase
  ...
  test "should create farm" do
    assert_difference('Farm.count') do
      post :create, farm: { : @farm., area: @farm.area, city: @farm.city, farmname: @farm.farmname, prefectures: @farm.prefectures }
    end
  ...
  test "should update farm" do
    patch :update, id: @farm, farm: { : @farm., area: @farm.area, city: @farm.city, farmname: @farm.farmname, prefectures: @farm.prefectures }
    assert_redirected_to farm_path(assigns(:farm))
  end
